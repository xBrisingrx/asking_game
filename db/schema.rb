...
ActiveRecord::Schema[7.0].define(version: 2022_08_01_220600) do
  ...
  create_table "game_answers", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.index ["question_id"], name: "index_game_answers_on_question_id"
  end
  ...
  add_foreign_key "game_answers", "questions"
